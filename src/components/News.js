      ...
      <>
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8 mx-8">
          <NewsItem
            ...
            description="myDesc"
            newsUrl="TODO"
            imageUrl="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80"
          ></NewsItem>
          <NewsItem
            title="myTitle"
            description="myDesc"
